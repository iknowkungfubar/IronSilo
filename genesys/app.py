...
# CORS — restrict origins via GENESYS_CORS_ORIGINS env var (comma-separated)
# Defaults to localhost only for development; never use wildcard in production.
_cors_origins = os.getenv("GENESYS_CORS_ORIGINS", "http://localhost:8080,http://127.0.0.1:8080")
app.add_middleware(
    CORSMiddleware,
