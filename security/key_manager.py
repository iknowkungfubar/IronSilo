...
class KeyManager:
    ...
    def _load_keystore(self, password: Optional[str] = None) -> None:
        ...
        try:
            if self._master_encryptor:
                ...
                self._keystore = KeyStore.model_validate_json(self._keystore_path.read_text())
    ...
    def _cleanup_old_keys(self) -> None:
        ...
        if len(sorted_keys) > self.max_keys:
            ...
            self._keystore.keys = [k for k in self._keystore.keys if k.is_active or k.is_primary]
