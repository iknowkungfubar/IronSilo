    ...
    if env == "development":
        ...
        if not origins:
            logger.warning(
                ...
                message="CORS_ORIGINS not set in production - blocking cross-origin requests",
            )
            allow_origins = []
        else:
            ...
            if not allow_origins:
                logger.warning(
                    "cors_empty_origins",
                    message="CORS_ORIGINS is empty in production - blocking cross-origin requests",
                )
                allow_origins = []
            else:
                ...
                if not allow_origins:
                    logger.warning(
                        "cors_all_origins_invalid",
                        message="No valid CORS origins - blocking cross-origin requests",
                    )
                    allow_origins = []
