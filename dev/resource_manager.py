...
class ResourceManager:
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "loaded_models": [
                {"name": m.name, "size": m.size, "state": m.state.value} for m in self.loaded_models.values()
            ],
        }
    ...
    def load_model(self, model: ModelInfo) -> Dict[str, Any]:
        ...
        return {"success": True, "vram_used_mb": self.vram_used_mb, "model": model.name}
    ...
    def unload_model(self, model_name: str) -> Dict[str, Any]:
        ...
        return {"success": True, "vram_used_mb": self.vram_used_mb}
