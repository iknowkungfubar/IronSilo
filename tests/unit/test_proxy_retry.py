...
class TestProxyRetryLogic:
    ...
    def test_proxy_has_retry_config(self):
        ...
        assert "RETRY_MAX_ATTEMPTS" in content or "max_retries" in content, "Proxy should have retry configuration"
    ...
    def test_proxy_has_backoff_delay(self):
        ...
        assert "backoff" in content.lower() or "delay" in content.lower(), "Proxy should have backoff delay logic"
    ...
    def test_proxy_retries_on_5xx_errors(self):
        ...
        assert (
            "500" in content or "502" in content or "503" in content or "504" in content or "status_code" in content
