...
class TestCacheKeyBuilder:
    ...
    def test_build_messages_key_with_params(self):
        ...
        key1 = CacheKeyBuilder.build_messages_key(messages, model="gpt-4", temperature=0.7)
        key2 = CacheKeyBuilder.build_messages_key(messages, model="gpt-3.5", temperature=0.7)
...
class TestKVCache:
    ...
    async def test_start_and_stop(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            await kv.set_response([{"role": "user", "content": "Test"}], {"response": "data"})
