...
class TestAgentBridgeEndpoints:
    ...
    def test_fail_task(self, client):
        ...
        # Fail the task
        response = client.post(f"/tasks/{task_id}/fail", params={"error_message": "Test error occurred"})
...
class TestTaskLifecycle:
    ...
    def test_failed_task_lifecycle(self, client):
        ...
        # Fail the task
        fail_response = client.post(f"/tasks/{task_id}/fail", params={"error_message": "Implementation error"})
